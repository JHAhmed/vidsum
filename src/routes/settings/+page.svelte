...
<div class="flex flex-col items-center justify-center py-32">
			...
			<h1
				class="mb-16 text-3xl leading-tight tracking-tighter text-gray-900 md:text-4xl lg:text-5xl dark:text-white"
			>
				Settings
			</h1>
	...
	<div class="z-100 space-y-6 min-w-xs md:min-w-lg">
		<div class="">
			<Tabs
				onValueChange={(newValue) => {shared.provider = newValue; shared.model = '';}}
		...
		<div class="">
			...
			<input
				id="api-key-input"
				type="text"
				placeholder={shared.provider === 'google' ? "Gemini API Key" : "OpenAI API Key"}
				bind:value={apiKey}
		...
		<div class="hidden">
			...
			<input
				id="model-input"
				type="text"
				placeholder={shared.provider === 'google' ? "gemini-2.0-flash" : "o4-mini"}
